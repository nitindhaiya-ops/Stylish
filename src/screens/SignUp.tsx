  ...
  return (
    <View style={styles.container}>
      ...
      <View style={{ alignItems: 'center', marginVertical: 10 }}>
        <Text style={{ color: '#575757', marginTop: 75 }}>
          - OR Continue with -
        </Text>
      </View>
      ...
      <View style={styles.loginOptionsWrapper}>
        ...
        <View style={styles.loginOptions}>
          <Svg width="25px" height="25px" viewBox="-3 0 262 262">
      ...
      <View style={styles.row}>
        <Text style={{ fontWeight: '400' }}>I Already Have an Account  </Text>
...
const styles = StyleSheet.create({
  ...
  loginOptions: {
    ...
    padding: 12,
    borderRadius: 50,
    backgroundColor: COLORS.primary_four,
  },
  registrationTextWrapper: { marginBottom: 20 },
  registrationText: { color: COLORS.text, fontWeight: '300', textAlign: 'left', fontSize: 16 },
});
