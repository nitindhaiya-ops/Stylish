...
/* -------------------------------------------------
   CountdownTimer – a tiny reusable component
   ------------------------------------------------- */
    ...
    const interval = setInterval(() => {
      setTimeLeft(prev => {
        ...
        if (seconds > 0) {
          ...
          // reset
          return { hours: 12, minutes: 8, seconds: 34 };
        }
  ...
  return (
    <View style={styles.timerRow}>
      <View style={styles.timeBox}>
        ...
        <Text style={[styles.white, styles.timeText]}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.Logoflex}>
          <Svg
            ...
            viewBox="0 0 125 100"
            fill="none"
            accessibilityLabel="Stylish logo">
            {/* logo SVG – unchanged */}
            <Path
            ...
            return (
              <TouchableOpacity
                ...
                <Text
                  style={[
                    styles.categoryText,
                    active ? styles.categoryTextActive : undefined,
                  ]}>
                  {item}
                </Text>
              </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  menuDivider: { height: 1, backgroundColor: '#f0f0f0', marginVertical: 16, marginHorizontal: 8 },
});
